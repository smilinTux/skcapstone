...
def install_cmd(name: str, email: str | None, home: str, skip_deps: bool, skip_seeds: bool, skip_ritual: bool):
    ...
    # Step 6: Write global CLAUDE.md for Claude Code auto-rehydration
    console.print("  [bold]6/6[/] Claude Code integration...", end=" ")
    claude_md_path = _write_global_claude_md(home_path, name)
    if claude_md_path:
        console.print(f"[green]done[/] [dim]{claude_md_path}[/]")
    else:
        console.print("[yellow]skipped (could not write CLAUDE.md)[/]")
    ...
    console.print(
        Panel(
            ...
            f"  skcapstone sync pair --export-pubkey  — share your GPG key",
            title="Sovereign",
            border_style="green",
        )
    )
