...
- Card `4db732af`: fleet worker briefs now materialize the final authoritative
  card evidence, model and seat policy, dependencies, and exact shared artifact
  paths before claim execution, with immutable typed reports for missing bytes.
