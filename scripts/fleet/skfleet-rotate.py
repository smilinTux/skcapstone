...
for _LANE,(_,_,cid,core,_labels,_nb) in picks:
    ...
    _RAILS=("CONSTRAINTS (standing rails, non-negotiable):\n"
      ...
      "   BEFORE push, run scripts/fleet/skfleet-pr-preflight.py against the exact\n"
      "   base and committed HEAD. Supply every card-authorized path with\n"
      "   --expected-path and write the immutable receipt under\n"
      "   ~/.skcapstone/evidence/work/<card_id>/local-ci-preflight.json. A failed\n"
      "   or missing receipt means BLOCKED: do not push, request review, or return\n"
      "   PASS_FOR_REVIEW. Record the receipt digest with the exact candidate head.\n"
